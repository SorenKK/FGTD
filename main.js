...
//usare startBackend1 per la modalità sviluppo con python
//usare startBackend per la modalità produzione con eseguibile
...
function startBackend() {
    ...
    if (isDev) {
        const script = path.join(__dirname, "backend", "app.py"); // o il file che contiene app.run()
